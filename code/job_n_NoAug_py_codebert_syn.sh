...
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ START TRAIN @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
bash run_NL_PL_new.sh 0 desc python program codebert train 10 $PROBING_CASE   # .sh파일명 이후, argument 순서대로 : gpu지정번호(안쓰임)/source언어/target언어/program인지snippet인지/모델/train인지eval인지/epoch수/probing_case변수
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ START EVAL @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
bash run_NL_PL_new.sh 0 desc python program codebert eval 10 $PROBING_CASE
